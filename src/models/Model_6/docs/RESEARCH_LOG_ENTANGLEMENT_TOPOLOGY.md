...
### L·PO10-2 — the first WEIGHT-LEVEL result: the pairing reaches Δw and is recoverable there (classical readout cannot) — a modest but robust keystone with a clean ladder · 2026-07-22 `[GROUNDED, measured — modest but robust weight-level keystone]`
